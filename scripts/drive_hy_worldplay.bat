@echo off
REM Stage HY-WorldPlay generations into Physics-IQ Verified, then evaluate.
REM
...
REM
REM   scripts\drive_hy_worldplay.bat --run-name hy-worldplay-op-run_01 --limit 1
REM   scripts\drive_hy_worldplay.bat --run-name hy-worldplay-op-run_01
REM   scripts\drive_hy_worldplay.bat --run-name hy-worldplay-op-run_02 --seed 1
...
if not exist "!FLASHDREAMS_ROOT!\integrations_v2\hy_worldplay" (
  echo ERROR: HY-WorldPlay integration not found: !FLASHDREAMS_ROOT!\integrations_v2\hy_worldplay 1>&2
...
echo ============================================================
echo   benchmark : !HERE!
echo   hyworld   : !FLASHDREAMS_ROOT!\integrations_v2\hy_worldplay
echo   driver    : !DRIVER!
echo ============================================================
