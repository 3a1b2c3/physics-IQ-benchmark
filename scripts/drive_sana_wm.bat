@echo off
REM Stage SANA-WM generations into Physics-IQ Verified, then evaluate.
REM
...
REM
REM   scripts\drive_sana_wm.bat --run-name sana-wm-op-run_01 --limit 1
REM   scripts\drive_sana_wm.bat --run-name sana-wm-op-run_01
REM   scripts\drive_sana_wm.bat --run-name sana-wm-op-run_02 --seed 1
...
if not exist "!FLASHDREAMS_ROOT!\integrations_v2\sana_wm" (
  echo ERROR: SANA-WM integration not found: !FLASHDREAMS_ROOT!\integrations_v2\sana_wm 1>&2
